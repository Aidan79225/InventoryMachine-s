package com.aidan.secondinventoryworkplatform.DatePicker.view;

import android.view.View;

import com.aidan.secondinventoryworkplatform.DatePicker.adapter.ArrayWheelAdapter;
import com.aidan.secondinventoryworkplatform.DatePicker.adapter.NumericWheelAdapter;
import com.aidan.secondinventoryworkplatform.DatePicker.lib.WheelView;
import com.aidan.secondinventoryworkplatform.DatePicker.listener.OnItemSelectedListener;
import com.aidan.secondinventoryworkplatform.DatePicker.utils.ChinaDate;
import com.aidan.secondinventoryworkplatform.DatePicker.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private static final int DEFAULT_START_YEAR = 1911;
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        // 年
        wv_year = (WheelView) view.findViewById(R.id.year);
        wv_year.setAdapter(new NumericWheelAdapter(startYear-1911, endYear-1911));// 设置"年"的显示数据
