...
public class TagCreator {
    public static Bitmap transStringToImage(String res, int widthPix, int heightPix, int textSizePix, int lineMargin) {
        Bitmap bmp = Bitmap.createBitmap(widthPix, heightPix, Bitmap.Config.ARGB_8888);
        ...
        canvas.drawRect(0, 0, widthPix, heightPix, paint);
        ...
        for (String temp : strings) {
            ...
            int count = 0;
            int lineWidth = widthPix / lines.length;
